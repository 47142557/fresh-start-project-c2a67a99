...
const HeroSection = () => {
  ...
  return <section className="py-20 md:py-32 px-4 bg-gradient-hero">
      <div className="container mx-auto">
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div className="animate-fade-in">
            ...
            <p className="text-xl text-muted-foreground mb-8 leading-relaxed">Compará planes de las mejores prepagas de Argentina y elegí el que mejor se adapte a tus necesidades. </p>
            <Button size="lg" className="text-lg px-8 py-6 bg-gradient-primary hover:opacity-90 transition-all shadow-colorful hover:shadow-card-hover" onClick={() => navigate('/comparar')}>
              Cotizar ahora
            </Button>
          </div>
            ...
            <div className="bg-card rounded-xl shadow-card border border-border overflow-hidden">
              ...
              <div className="p-8 space-y-4">
                ...
                <div className="grid grid-cols-3 gap-4 mt-6">
                  {[1, 2, 3].map(i => <div key={i} className="bg-muted p-4 rounded-lg border border-border hover:shadow-card transition-shadow">
